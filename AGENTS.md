...
## 📥 Download Persistence Rule

**When downloads fail:**
1. **Retry 3-5 times** before giving up
2. Use **long timeouts** (600s+) for large files
3. Only suggest alternatives after multiple failures
4. Network conditions change — what fails now may succeed later

*Learned from v2ray download: 3 attempts needed for 14.2MB file.*
